...
class CipherTextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        our_shift = list2.index(max(list2)) + 1
        return self.apply_shift(26 - our_shift)


shift = int(input('enter a proper shift'))

story = get_story_string('story.txt')
massage = PlaintextMessage(story, shift)
enc = massage.get_message_text_encrypted()
